...
iso_name=RebornOS
iso_label="RebornOS"
iso_publisher="RebornOS GNU/Linux <https://rebornos.org>"
iso_application="RebornOS GNU/Linux Live/Rescue CD"
...
make_custom_airootfs() {
	...
	echo "VERSION=$iso_version" >> "${_airootfs}/usr/lib/rebornos-release"
