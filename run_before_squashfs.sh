...
arch_chroot "
wget https://repo.rebornos.org/RebornOS/sources/cnchi/testing/new-cnchi-20210615-2-any.pkg.tar.zst
tar -xvf new-cnchi-20210615-2-any.pkg.tar.zst
rm new-cnchi-20210615-2-any.pkg.tar.zst
