...
arch_chroot "
wget https://repo.rebornos.org/RebornOS/sources/cnchi/new-cnchi-20210630-1-any.pkg.tar.zst
tar -xvf new-cnchi-20210630-1-any.pkg.tar.zst
rm new-cnchi-20210630-1-any.pkg.tar.zst
